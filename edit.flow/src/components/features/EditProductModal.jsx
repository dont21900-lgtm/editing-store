...
const EditProductModal = ({ product, onClose, onUpdateSuccess }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="relative bg-[#050505] border border-white/20 w-full max-w-2xl max-h-[90vh] overflow-y-auto custom-scrollbar p-8 shadow-2xl animate-fade-in">
                ...
                <form onSubmit={handleUpdateProduct} className="space-y-6">
                    ...
                    <button type="submit" disabled={isUploading} className="w-full py-4 bg-white text-black font-bold uppercase tracking-widest hover:bg-[#6500aa] hover:text-white transition-colors border border-transparent hover:border-white">
